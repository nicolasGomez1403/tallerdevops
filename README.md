# Sistema de Gestión Académica - MVC FastAPI + DevOps (Versión 2)

Proyecto base desarrollado con **FastAPI**, **SQLModel**, motor de plantillas **Jinja2** y un módulo de indicadores de rendimiento académico en **Python**, preparado para la evaluación de estrategias de ramificación en Git, Integración Continua (CI) y pruebas automatizadas con **pytest**.
...
* **Validar umbral mínimo de cobertura (85% requerido en CI):**
  ```bash
...
├── logica.py           # Reto de lógica de calificaciones (calcular_indicadores_rendimiento)
